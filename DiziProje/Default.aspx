...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="content-grid">
                            <div class="content-grid-info">
                                ...
                                <div class="post-info">
                                    ...
                                    <p class="blog-content-preview"><%# Eval("BLOGICERIK") %></p>
                                    <p class="blog-content-full" style="display: none;"><%# Eval("BLOGICERIK") %></p>
                                    <a href="BlogDetay.aspx?BLOGID=<%# Eval("BLOGID") %>" class="read-more-link"><span></span>Devamını Oku</a>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.querySelectorAll(".content-grid-info .blog-content-preview").forEach(function (preview) {
            LimitText(preview, 500);
        });
